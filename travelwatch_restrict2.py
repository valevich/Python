...
def read_function7():                    
    ...
    sourcefile1 = "/Users/henryvalevich/Downloads/Json/restrictionsadvisories.json"
    destfile1 = "/Users/henryvalevich/FlutterProjects/jsonhost/travelwatch/restrictionsadvisories.json"
    sourcefile2 = "/Users/henryvalevich/Downloads/Json/kayak_restrictions.json"
    destfile2 = "/Users/henryvalevich/FlutterProjects/jsonhost/travelwatch/kayak_restrictions.json"
    copyfile(sourcefile1, destfile1)
    copyfile(sourcefile2, destfile2)

    from git import Repo

    path = "/Users/henryvalevich/FlutterProjects"
    retval = os.getcwd()
    os.chdir( path )
    retval = os.getcwd()
    ...
    repo = Repo(repo_dir)
    file_list = [
        '/Users/henryvalevich/FlutterProjects/jsonhost/travelwatch/kayak_restrictions.json',
        '/Users/henryvalevich/FlutterProjects/jsonhost/travelwatch/restrictionsadvisories.json'
    ]
    commit_message = 'Updated JSON files'
    repo.index.add(file_list)
    repo.index.commit(commit_message)
    origin = repo.remote('origin')
    origin.push()

    print ("Step 7: Git Pushed files:")
    print ("            restrictionsadvisories.json")
    print ("            kayak_restrictions.json")
    print ("=====================  END  =====================")
